    ...
    <section className="relative flex flex-col lg:flex-row items-center justify-center lg:justify-between px-6 py-24 bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 overflow-hidden">
      ...
      >
        ...
        <motion.p
          ...
          variants={textVariants}
        >
          KessabPro helps farmers track animals, manage sales, and streamline
        ...
        >
          ...
          <Button
            variant="outline"
            className="px-6 py-3 text-lg border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition-transform transform hover:scale-105"
          >
            Learn More
          </Button>
        </motion.div>
      ...
      <motion.img
        ...
        loading="lazy"
        decoding="async"
        className="w-[80%] max-w-[600px] rounded-lg drop-shadow-[0_20px_40px_rgba(0,0,0,0.35)] transition-transform transform hover:scale-105 hover:drop-shadow-[0_30px_50px_rgba(0,0,0,0.4)]"
